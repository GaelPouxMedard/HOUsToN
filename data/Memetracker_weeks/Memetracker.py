...
def timeStamp(d):
    ...
    timestamp = datetime.datetime.timestamp(date)/(3600*24*7)  # weeks
    return timestamp
...
numNode, numWds = 0, 0
with open("Memetracker_events.txt", "w+", encoding="utf-8") as f:
